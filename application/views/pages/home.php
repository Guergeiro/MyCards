<main>
				...
				<div class="card-deck text-center">
					<div class="col-lg-4 col-md-6">
						<div class="card my-4">
							<div class="view overlay">
								...
								<a href="#!">
									<div
										class="mask rgba-white-strong d-flex align-items-center justify-content-center">
										<h3>Básico</h3>
									</div>
								</a>
							</div>
							...
							<div class="card-body">
								...
								<p class="card-text text-success">Estatísticas Gerais <i
										class="far fa-check-circle"></i>
								</p>
								<p class="card-text text-danger">Recompensas pontuais <i
					...
					<div class="col-lg-4 col-md-6">
						<div class="card my-4">
							...
							<div class="card-body">
								...
								<p class="card-text text-success">Recompensas pontuais <i
										class="far fa-check-circle"></i>
								</p>
								<p class="card-text text-danger">Patamar de pontos <i class="far fa-times-circle"></i>
								</p>
					...
					<div class="col-lg-4 col-md-12">
						<div class="card my-4">
							...
							<div class="card-body">
								<h4 class="card-title">Inclui</h4>
								<p class="card-text text-success">Campanhas Ilimitadas <i
										class="far fa-check-circle"></i>
								</p>
								<p class="card-text text-success">Cupões de Desconto Direto <i
										class="far fa-check-circle"></i>
	...
	<section class="container py-4" id="contato">
		...
		<p class="text-center">Tem alguma questão? Não hesite a contactar-nos diretamente. Seremos o mais breves possiveis.</p>
		<div class="row">
			<!--Grid column-->

            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-4 mt-2">
                    ...
                    <div class="row pl-3 pr-3 pb-1">
                        <div class="card w-100">
                            <div class="card-header">
                                <h4 class="text-primary">Logo Empresa</h4>
    ...
    <div class="modal-dialog modal-full-height modal-right" role="document">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="md-form md-outline">
                    <i class="fas fa-signature prefix"></i>
                    <input type="text" id="primeiroNomeColaborador" class="form-control" maxlength="50">
                    <label for="primeiroNomeColaborador">Segundo nome do Colaborador</label>
                ...
                <div class="md-form md-outline">
                    ...
                    <label for="userColaborador">Nome do Utilizador do Colaborador</label>
                    <small class="text-primary ml-2">Segundo nome do Colaborador pode ter (0-50) caracteres.</small>
                </div>
                ...
                <div class="md-form md-outline">
                    <i class="fas fa-key prefix"></i>
                    <input type="password" id="passwordNomeColaborador" class="form-control" maxlength="50">
                    <label for="passwordNomeColaborador">Password do Colaborador</label>

<main class="container d-flex align-items-center justify-content-center py-4">
  <div class="row">
      ...
      <div class="card text-center">
        ...
        <div class="container">
          ...
          <p><a href="https://github.com/guergeiro/" target="_blank" role="button" class="btn btn-primary p-3"><i
              ...
              class="btn btn-primary p-3"><i class="fab fa-fw fa-2x fa-linkedin-in" aria-hidden="true"></i></a>
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="col-lg-3 col-md-6 my-3">
      <div class="card text-center">
        <img src="<?php echo base_url("assets/imgs/team/falcao.jpg")?>" alt="Diogo Costa">
        <div class="container">
          <h2>Diogo C.</h2>
          <p class="title">Software/Web Developer</p>
          <p>Some text that describes me lorem ipsum ipsum lorem.</p>
          ...
          <p><a href="https://github.com/diogofalken/" target="_blank" role="button" class="btn btn-primary p-3"><i
              ...
              class="btn btn-primary p-3"><i class="fab fa-fw fa-2x fa-linkedin-in" aria-hidden="true"></i></a></p>
        </div>
      </div>
    </div>
    ...
    <div class="col-lg-3 col-md-6 my-3">
      <div class="card text-center">
        <img src="<?php echo base_url("assets/imgs/team/oliveira.jpg")?>" alt="Diogo Oliveira">
        <div class="container">
          <h2>Diogo O.</h2>
    ...
    <div class="col-lg-3 col-md-6 my-3">
      <div class="card text-center">
        <img src="<?php echo base_url("assets/imgs/team/filipe.jpg")?>" alt="Filipe Ribeiro">
        <div class="container">
          <h2>Filipe R.</h2>

	...
	<div class="card">
		...
		<div class="card-body">
			<div class="row" style="text-align: center">
				<div class="col-6 col-md-3 teste shadow p-2 my-2 text-primary" data-toggle="tooltip"
			...
			fidelização de clientes na Empresa.">
				...
				<div class="col-6 col-md-3 teste shadow p-2 my-2 text-muted" data-toggle="tooltip" data-placement="top"

...
<head>
    ...
    <!-- Custom CSS -->
    <link rel="stylesheet" type="text/css" href="<?php echo base_url('PINT-Web/assets/css/Empresa/Def_Empresariais.css'); ?>">
            ...
            <div class="nav-side-menu position-absolute" id="sidebarMenu">
                ...
                <div class="menu-list">
                    ...
                    <ul id="menu-content" class="menu-content">
                        ...
                        <li>
                            <a href="<?php echo base_url('PINT-Web/Index.php/controller_CarregarViews/viewDashboard') ?>">
                        ...
                        <ul class="sub-menu collapse" id="campanhas">
                            ...
                            <li><a href="<?php echo base_url('PINT-Web/Index.php/controller_CarregarViews/viewCampanhas_AtivarCampanhas') ?>">Ativar Campanha</a></li>
                        </ul>
                        <!-- Ending List-Element Campanhas -->

                        <!-- Begining List-Element Reportings -->
                        <li>
                            <a href="<?php echo base_url('PINT-Web/ontroller_CarregarViews/viewReportingsDados') ?>">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="imgPreview">
                                    <img id="imgPreviewSorce" src="<?php echo base_url('PINT-Web/assets/Imagens/User.svg.png'); ?>" alt="">
                                </div>
